...
als.Metro.prototype = {
	...
	addEventListener	: function(name,func){
		...
		// stationchange
		// mapchange
		self.node.bind(name,func);
//
//		if(name == 'stationchange'){
//			self.eachStation(function(i,station){
//				station.onStateChange(func);
//			});
//		}
	},
	removeEventListener	: function(name,func){
		...
		self.node.unbind(name,func);

//		if(name == 'stationchange'){
//			self.eachStation(function(i,station){
//				station.unbindStateChange(func);
//			});
//		}
	},
	...
	setSelectedStations	: function(list,bInv){
		var	self = this;
		list = list || [];

		self.eachStation(function(i,station){
			//var b = _check(station.id);
			//console.log((bInv||0)*1 - b)
			station.stateChange((bInv||0)*1 - _check(station.id));
		});
